...
import { DISPATCH_LEAD_MS, INGEST_JOBS } from "../cloudflare/scheduler/worker.mjs";
...
test("ingest scheduler applies a one-minute dispatch lead", () => {
  assert.equal(DISPATCH_LEAD_MS, 60_000);
});
